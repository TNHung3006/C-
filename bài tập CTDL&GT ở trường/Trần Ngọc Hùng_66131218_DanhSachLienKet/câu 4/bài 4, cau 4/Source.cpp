//4. Tạo danh sách liên kết đơn lưu trữ các số thực.Tính tổng các số âm trong danh sách liên kết đơn
//đã tạo.
#include <iostream>
...
int main() {
	...
	DuyetDS(head);
	cout << "tong cac so am trong danh sach lien ket: " << inketqua(head);
